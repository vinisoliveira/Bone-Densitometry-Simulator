...
const createStyles = (theme) => StyleSheet.create({
  ...
  sidePanel: { width: 200, backgroundColor: theme.editorPanel, borderLeftWidth: 1, borderLeftColor: theme.editorBorder },
  ...
  regionItemText: { flex: 1, fontSize: 12, color: theme.textMuted, fontWeight: '500' },
