...
const styles = StyleSheet.create({
  ...
  notePanel: { flexDirection: 'row', backgroundColor: '#0d1117', padding: 10, borderRadius: 6, borderWidth: 1, borderColor: '#3498DB33', gap: 8, alignItems: 'flex-start' },
  noteText: { flex: 1, fontSize: 9, color: '#8892B0', lineHeight: 14 },
