...
const createStyles = (theme) => StyleSheet.create({
  ...
  areaText: { fontSize: 11, color: theme.textMuted },
  ...
  fraxPanel: { backgroundColor: theme.editorBg, padding: 10, borderRadius: 6, marginTop: 8, borderWidth: 1, borderColor: '#FFC10733' },
  ...
  fraxLabel: { fontSize: 10, color: theme.textMuted },
  fraxValue: { fontSize: 10, color: theme.text, fontWeight: '600' },
